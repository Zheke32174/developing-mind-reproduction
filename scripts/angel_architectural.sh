...
claude -p "Perform an architectural audit of the current substrate changes. Verify alignment with the Sovereign Agent Roadmap and flag any design anti-patterns."
